...
/// @title Pegasys v1 Helper Library
/// @notice Calculates the recipient address for a command
library PegasysV1Library {
    error InvalidReserves();
    error InvalidPath();

    /// @notice Calculates the v1 address for a pair without making any external calls
    /// @param factory The address of the v1 factory
    /// @param initCodeHash The hash of the pair initcode
    /// @param tokenA One of the tokens in the pair
    /// @param tokenB The other token in the pair
    /// @return pair The resultant v1 pair address
    function pairFor(
        address factory,
    ...
    /// @notice Calculates the v1 address for a pair and the pair's token0
    /// @param factory The address of the v1 factory
    /// @param initCodeHash The hash of the pair initcode
    /// @param tokenA One of the tokens in the pair
    /// @param tokenB The other token in the pair
    ...
    /// @notice Calculates the v1 address for a pair assuming the input tokens are pre-sorted
    /// @param factory The address of the v1 factory
    /// @param initCodeHash The hash of the pair initcode
    ...
    /// @notice Calculates the v1 address for a pair and fetches the reserves for each token
    /// @param factory The address of the v1 factory
    /// @param initCodeHash The hash of the pair initcode
    /// @param tokenA One of the tokens in the pair
    /// @param tokenB The other token in the pair
